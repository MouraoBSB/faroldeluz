        ...
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    $whatsappUrl = $settingModel->get('whatsapp_url');
                    ?>
                    <ul class="space-y-3 text-sm text-cinza-azulado">
                        <?php if ($contactEmail): ?>
                        <li>
                        ...
                        <?php if ($whatsappUrl): ?>
                        <li>
                            <a href="<?= $whatsappUrl ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold transition">
