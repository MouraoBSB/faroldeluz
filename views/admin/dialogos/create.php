    ...
    <div class="flex-1 overflow-auto">
        <div class="p-8">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-dourado-luz mt-4">Novo Diálogo</h1>
            </div>
            ...
            <form method="POST" action="<?= base_url('admin/dialogos/criar') ?>" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" required
                                   ...
                                   placeholder="Ex: Diálogo sobre Espiritismo e Ciência">
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-cinza-azulado mt-2">Cole a URL completa do vídeo do YouTube</p>
                        </div>
