    ...
    <div class="flex-1 overflow-auto">
        <div class="p-8">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-dourado-luz mt-4">Novo Rajian</h1>
            </div>
            ...
            <form method="POST" action="<?= base_url('admin/rajian/criar') ?>" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" required
                                   ...
                                   placeholder="Ex: Estudo sobre O Livro dos Espíritos">
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-cinza-azulado mt-2">Thumbnail do vídeo (recomendado: 1280x720px)</p>
                        </div>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="<?= base_url('admin/rajian') ?>" class="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-lg font-semibold transition inline-block">
                        ✕ Cancelar
                    </a>
                </div>
            </form>
