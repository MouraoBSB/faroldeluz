<?php
$pageTitle = $dialogo['seo_title'] ?: $dialogo['title'];
$metaDescription = $dialogo['seo_meta_description'] ?: strip_tags($dialogo['description_html']);
$ogUrl = base_url("dialogos/{$dialogo['slug']}");
$ogImage = $dialogo['cover_image_url'] ? base_url($dialogo['cover_image_url']) : '';
...
$embedUrl = getYoutubeEmbedUrl($dialogo['youtube_url']);
?>
...
<article class="pt-32 pb-16 min-h-screen">
    <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
            <div class="mb-8">
                <a href="<?= base_url('dialogos') ?>" class="text-azul-turquesa hover:text-dourado-luz transition inline-flex items-center gap-2">
            ...
            <div class="bg-azul-cosmico/50 rounded-lg border border-azul-medio p-8">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        <h3 class="text-xl font-bold text-dourado-luz mb-2">Compartilhe este diálogo</h3>
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="https://twitter.com/intent/tweet?url=<?= urlencode($ogUrl) ?>&text=<?= urlencode($dialogo['title']) ?>" 
                           target="_blank"
                        ...
                        <a href="https://api.whatsapp.com/send?text=<?= urlencode($dialogo['title'] . ' - ' . $ogUrl) ?>" 
                           target="_blank"
